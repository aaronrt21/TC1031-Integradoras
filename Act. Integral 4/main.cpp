...
El usuario puede decidir si quiere organizar el registro, realizar una búsqueda por ID específico, recibir todos los ID's existentes dentro
...
int main() {
	...
	while (option1 < 1 || option1 > 4){
		...
		if(option1 == 2){
          ...
          if (cont == 0){
            cout << "No existe un ID en el rango introducido o el rango introducido no es valido.";
          }
					return 0;
    ...
    if (option1 == 3){
      ...
      //Se despliegan los amigos de cada usuario usando la representación por lista adyacente.
      cout << amigos.printAdjList() << "\n\n";
      return 0;
    }
		if (option1 == 4){
			cout << "\n\n//////////CASOS DE PRUEBA//////////\n";
